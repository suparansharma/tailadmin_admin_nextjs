...
const SignInComponent = ({ submitForm, setEmail, setPassword, setLoading, loading }) => {
    ...
    //     // Check password strength and update the state accordingly
    //     setPasswordStrengthError(!checkPasswordStrength(newPassword));
    // };
    ...
    const handlePasswordChange = (e) => {
        ...
        // Check password length and update the state accordingly
