    ...
    >
      ...
      <div className="flex items-center justify-between gap-2">
        <Link href="/dashboard" legacyBehavior>
          <a className={`flex justify-center items-center w-full border-b`} style={{height: '80px'}}><img style={{height: '60px', margin: '0 auto'}} src={"/images/logo/logo.png"}/></a>
        </Link>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
        <nav className="my-2.5 px-4 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  <svg className="fill-current" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="16" height="16"
                       viewBox="0 0 128 128">
                    <path
